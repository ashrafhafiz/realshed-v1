...
@section('content')
    <div class="flex-wrap d-flex justify-content-between align-items-center grid-margin">
        ...
        <div class="flex-wrap d-flex align-items-center text-nowrap">
            <div class="mb-2 input-group date datepicker wd-200 me-2 mb-md-0" id="dashboardDate">
                <span class="bg-transparent input-group-text input-group-addon border-primary"><i data-feather="calendar"
                        class=" text-primary"></i></span>
                <input type="text" class="bg-transparent form-control border-primary">
            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <div class="mb-2 dropdown">
                                    <button class="p-0 btn" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <div class="mb-2 dropdown">
                                    <button class="p-0 btn" type="button" id="dropdownMenuButton1"
            ...
            <div class="overflow-hidden card">
                <div class="card-body">
                    <div class="mb-4 d-flex justify-content-between align-items-baseline mb-md-3">
                        ...
                        <div class="dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2 d-flex justify-content-between align-items-baseline">
                        ...
                        <div class="mb-2 dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton4" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2 d-flex justify-content-between align-items-baseline">
                        ...
                        <div class="mb-2 dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton5" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2 d-flex justify-content-between align-items-baseline">
                        ...
                        <div class="mb-2 dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton6" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
                    ...
                    <div class="d-flex flex-column">
                        <a href="javascript:;" class="pb-3 d-flex align-items-center border-bottom">
                            ...
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-1 fw-normal text-body">Leonardo Payne</h6>
                        ...
                        <a href="javascript:;" class="py-3 d-flex align-items-center border-bottom">
                            ...
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-1 fw-normal text-body">Carl Henson</h6>
                        ...
                        <a href="javascript:;" class="py-3 d-flex align-items-center border-bottom">
                            ...
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-1 fw-normal text-body">Jensen Combs</h6>
                        ...
                        <a href="javascript:;" class="py-3 d-flex align-items-center border-bottom">
                            ...
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-1 fw-normal text-body">Amiah Burton</h6>
                        ...
                        <a href="javascript:;" class="py-3 d-flex align-items-center border-bottom">
                            ...
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-1 fw-normal text-body">Yaretzi Mayo</h6>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2 d-flex justify-content-between align-items-baseline">
                        ...
                        <div class="mb-2 dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton7" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
